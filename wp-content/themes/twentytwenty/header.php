							...
							<ul class="header__list">
								...
								foreach ($result_array as $item) {
									...
									if (empty($item['children'])) { ?>
										<script>
											console.log(<?php print_r(json_encode(home_url() . $current_url)) ?>)
										</script>
...
<!--                                </li>-->
	...
	<main class="main">
		...
		if (
			...
			&& !is_page_template('templates/privacy-policy-template.php') && !is_page_template('templates/video-template.php') && !is_search() && !is_checkout()
		) {
			custom_breadcrumbs();
		}
		?>