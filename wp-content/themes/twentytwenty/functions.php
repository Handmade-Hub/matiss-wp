...
function twentytwenty_register_styles()
{
	...
	// wp_enqueue_style('reset', get_template_directory_uri() . '/assets/css/reset.css', null, $theme_version);
	wp_enqueue_style('styles', get_template_directory_uri() . '/assets/css/styles.css', null);
	wp_enqueue_style('aos', 'https://unpkg.com/aos@2.3.1/dist/aos.css', null, $theme_version);
}
...
function twentytwenty_register_scripts()
{
	...
	wp_enqueue_script('aos', 'https://unpkg.com/aos@2.3.1/dist/aos.js', array(), $theme_version);
	wp_script_add_data('aos', 'strategy', '');
}
...
//         $message = '<div class="wpcf7-response-output" aria-hidden="true"></div>
// 		<script>successedMessage()</script>';
//     }
//     return $message;
// }
